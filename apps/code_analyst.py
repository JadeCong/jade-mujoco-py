...
Description: Analyse how many lines of source code in provide project directory.
FilePath: /PycharmProjects/aisono-mujoco-py/apps/code_analyst.py
"""
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        ...
        print("Code Analyst Result: Code Lines Table")
        print_result()
